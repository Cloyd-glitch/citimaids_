      ...
      <div className="max-w-xl mx-auto px-6 w-full">
        ...
        >
          ...
          <div className="mt-6 pt-5 border-t border-slate-100">
            <div className="flex items-center gap-2.5 p-3 rounded-xl bg-blue-50/80 border border-blue-100 text-xs text-blue-900">
              <span>ℹ️</span>
        ...
        <div className="flex flex-col gap-3">
          <a
            ...
            className="flex items-center justify-center gap-2 py-3.5 rounded-xl font-bold text-sm text-white bg-emerald-500 hover:bg-emerald-600 transition-all shadow-md hover:scale-[1.02]"
          >
          ...
          <Link
            to="/"
            className="block text-center py-3.5 rounded-xl font-bold text-sm text-slate-800 bg-white border border-slate-200 hover:bg-slate-50 transition-colors"
          >
            Back to Homepage
          </Link>
        </div>
