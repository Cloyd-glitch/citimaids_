        ...
        <div style={{ display: 'flex', minHeight: '100vh', background: '#f0f2f5' }}>
            ...
            <aside style={{
                ...
                <div style={{
                    ...
                    <div>
                        <div style={{ color: '#fff', fontWeight: 700, fontSize: 15, letterSpacing: 0.5 }}>CITIMAIDS</div>
                        <div style={{ color: '#64748b', fontSize: 11 }}>Cleaning Services</div>
                    </div>
                </div>

                {/* Nav */}
                <nav style={{ flex: 1, padding: '16px 10px' }}>
                    <div style={{ color: '#64748b', fontSize: 11, fontWeight: 600, padding: '8px 12px', textTransform: 'uppercase', letterSpacing: 1 }}>Main Menu</div>
                    {navItems.map(item => (
                        <NavLink
                            key={item.path}
                            to={item.path}
